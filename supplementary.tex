...
% Hardcoded pointers into the compiled main paper.
% (Overleaf often compiles the supplementary without a usable main.aux,
%  so \eqref/\ref via xr show as ``?''.)
\newcommand{\mainEqInject}{(6)}
\newcommand{\mainEqSampler}{(7)}
\newcommand{\mainEqResidual}{(9)}
\newcommand{\mainEqUpdate}{(10)}
\newcommand{\mainTabHealthyFP}{Table~1}
\newcommand{\mainTabCross}{Table~2}
\newcommand{\mainFigQualLIDC}{Figure~2}
...
(Eqs.~\mainEqInject{}--\mainEqUpdate{} in the main paper).
...
\begin{figure*}[t]
  ...
  Columns match \mainFigQualLIDC{} in the main paper.
  Object-centric baselines often fill the box; Ours
  (\(60\)-step, \(R{=}3\); \mainTabHealthyFP{} in the main paper)
...
\begin{figure*}[t]
  ...
  Aggregate numbers match \mainTabCross{} in the main paper.}
  \label{fig:bench}
\end{figure*}
...
\begin{figure*}[t]
  ...
  Illustrative examples under matched boxes; see \mainTabCross{}
...
(\mainTabHealthyFP{} in the main paper) on nodule-free MAISI
...
\mainTabCross{} in the main paper
...
(\mainTabCross{} in the main paper). SAM-Med3D returns an empty
...
\mainTabCross{} in the main paper for true-nodule Dice).
