...
Figure~\ref{fig:qual-fp} (Supplementary Material) illustrates empty-GT random boxes where
...
(Supplementary Material) report mean Dice under the same matched-box protocol on
...
Figures~\ref{fig:qual-cross} and~\ref{fig:qual-nsclc-vol}
(Supplementary Material) show corresponding overlays on MAISI
synthetic nodules, matched NSCLC \(64^3\) tumor patches, and the
same NSCLC cases as full-volume slices. The qualitative pattern is consistent with the
...
and~\ref{fig:qual-ablation} (Supplementary Material) vary
...
\ref{fig:qual-ablation}; Supplementary Material) indicates that additional sampling steps beyond this
point yield little further Dice gain on LIDC. Qualitative overlays
(Figure~\ref{fig:qual-lidc}; Figures~\ref{fig:qual-fp},~\ref{fig:qual-cross},
and~\ref{fig:qual-nsclc-vol} in the Supplementary Material) illustrate the same pattern under matched
