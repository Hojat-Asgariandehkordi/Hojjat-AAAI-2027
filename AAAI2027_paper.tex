...
padding. Ours converts these boxes into an inpainting hole;
foundation models consume them as box interactions.
...
(mm\(^3\)) rather than Dice-vs-empty.
...
\begin{figure}[t]
  ...
  (b)~LIDC true-nodule Dice vs.\ healthy FP volume.}
