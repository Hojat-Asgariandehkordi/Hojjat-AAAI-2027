...
\begin{figure*}[t]
  ...
  \(R\) rounds.
  \textbf{Bottom:} successive mask refinements
  (red\,=\,GT, lime\,=\,prediction).
  Image panels show three consecutive axial slices of \(64^{3}\) patches
  (training example LIDC \#1370; inference example LIDC \#1183).}
  \label{fig:method}
\end{figure*}
