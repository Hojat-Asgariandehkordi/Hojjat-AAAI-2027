...
shows the corresponding overlays on MAISI synthetic nodules and NSCLC
tumors: Ours again tracks irregular GT boundaries closely, while the
same foundation columns exhibit under-segmentation, boxy inflation, or
scattered false positives. This suggests the healthy-prior residual is
...
\begin{figure*}[t]
  ...
  Bottom: NSCLC-Radiomics tumors with Ours (\(60\)-step, \(R{=}1\)).
...
(Figures~\ref{fig:qual-lidc},~\ref{fig:qual-fp}, and~\ref{fig:qual-cross})
